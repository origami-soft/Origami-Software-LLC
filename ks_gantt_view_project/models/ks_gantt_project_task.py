...
class KsProjectTask(models.Model):
    ...
    ks_task_color = fields.Char(string="Task Color")
    ...
    def ks_compute_color(self):
        for ks_task in self:
            if ks_task.ks_task_color:
                ks_task.ks_color = ks_task.ks_task_color
                if ks_task.stage_id.name == 'Cancelada' or ks_task.stage_id.name == 'En Proceso' and ks_task.stage_id.ks_stage_color:
