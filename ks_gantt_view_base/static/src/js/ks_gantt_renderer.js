odoo.define("ks_gantt_view.Renderer", function (require) {
  ...
  var ksGanttRenderer = AbstractRenderer.extend({
    ...
    ks_parse_gantt_data: function () {
      ...
      //only parse unscheduled false task by @hachecito
      function unscheduled_tasks(ks_data) {
          if (!ks_data.unscheduled) return ks_data;
      }
      ks_render_data["data"] = ks_data.filter(unscheduled_tasks);
...
//                        'ks_allow_parent_task': each_project_task.ks_allow_subtask,
    ...
    ks_gantt_layout: function () {
      ...
      var ks_gantt_cols = [];
      gantt.config.ks_grid_width = ($(window).width() / 100) * 31;
      ...
      let ks_gantt_config_columns = [
        ...
        },
        {
          ...
          template: function (task) {
            ...
            ks_task_difference = ks_task_difference.split(",")[0]
        ...
        },
        {
          ...
          template: function (task) {
            if (task.end_date) {
              return gantt.ks_gantt_view_datetime_format(task.end_date);
            }
            return "";
          },
        },
...
//          els.appendChild(task_duration_el);
    ...
    ks_gantt_view_datetime_format: function () {
      ...
      gantt.ks_gantt_view_datetime_format = function (ks_input_datetime) {
        return moment(ks_input_datetime).format("DD/MM/YYYY");
      };
    },
